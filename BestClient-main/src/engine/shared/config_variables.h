...
MACRO_CONFIG_INT(ClTeeLine, tee_line, 0, 0, 1,
    CFGFLAG_CLIENT | CFGFLAG_SAVE,
    "Show lines from your tee to dead tees")

MACRO_CONFIG_INT(ClTeeLineDistance, tee_line_distance, 64, 1, 1000,
    CFGFLAG_CLIENT | CFGFLAG_SAVE,
    "Maximum distance for dead tee lines in tiles")

MACRO_CONFIG_COL(ClTeeLineColor, tee_line_color, 0x33CCFF,
    CFGFLAG_CLIENT | CFGFLAG_SAVE,
    "Color of dead tee lines")

MACRO_CONFIG_INT(ClTeeLineThickness, tee_line_thickness, 2, 1, 20,
    CFGFLAG_CLIENT | CFGFLAG_SAVE,
    "Thickness of dead tee lines")