/* Copyright Р В РІР‚в„ўР вЂ™Р’В© 2026 BestProject Team */
...
MACRO_CONFIG_COL(BcScoreboardBackgroundColor, bc_scoreboard_background_color, 0xD61F0F33U, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Tab background color")
MACRO_CONFIG_COL(BcScoreboardPingBarColor, bc_scoreboard_ping_bar_color, 0xFF9E29FFU, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Tab ping bar color")
MACRO_CONFIG_COL(BcScoreboardPingTextColor, bc_scoreboard_ping_text_color, 0xFFC752FFU, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Tab ping text color")
MACRO_CONFIG_INT(BcScoreboardTransparency, bc_scoreboard_transparency, 0, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Additional Tab transparency")
...
MACRO_CONFIG_INT(BcFreezeLaser, bc_freeze_laser, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable freeze tee hook laser")
MACRO_CONFIG_COL(BcFreezeLaserColor, bc_freeze_laser_color, 0x3399FFFF, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Main freeze tee hook laser color")
MACRO_CONFIG_INT(BcFreezeLaserMaxDistance, bc_freeze_laser_max_distance, 1500, 100, 5000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Maximum freeze tee hook laser distance")
MACRO_CONFIG_INT(BcFreezeLaserWidth, bc_freeze_laser_width, 3, 1, 20, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Freeze tee hook laser width")
MACRO_CONFIG_INT(BcFreezeLaserAlpha, bc_freeze_laser_alpha, 100, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Freeze tee hook laser opacity")
MACRO_CONFIG_INT(BcFreezeLaserStyle, bc_freeze_laser_style, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Freeze tee hook laser style (0 = solid, 1 = dashed)")
MACRO_CONFIG_COL(BcFreezeLaserHookableColor, bc_freeze_laser_hookable_color, 0x00FF00FF, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Freeze tee hookable segment color")
MACRO_CONFIG_COL(BcFreezeLaserUnhookableColor, bc_freeze_laser_unhookable_color, 0xFF3333FF, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Freeze tee unhookable segment color")
