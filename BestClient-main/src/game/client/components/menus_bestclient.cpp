/* Copyright Р’В© 2026 BestProject Team */
...
void CMenus::RenderSettingsBestClientVisuals(CUIRect MainView)
{
  ...
  // Scoreboard / Tab colors
  const float ScoreboardColorPickerLineSize = 25.0f;
  const float ScoreboardColorPickerSpacing = 5.0f;
  const float ScoreboardColorsBlockHeight = LineSize + MarginSmall + LineSize + MarginSmall + 3.0f * (ScoreboardColorPickerSpacing + ScoreboardColorPickerLineSize);

  CUIRect ScoreboardColorsBlock;
  RightColumn.HSplitTop(MarginBetweenViews, nullptr, &RightColumn);
  RightColumn.HSplitTop(ScoreboardColorsBlockHeight, &ScoreboardColorsBlock, &RightColumn);

  CUIRect ScoreboardColorsBlockBg = ScoreboardColorsBlock;
  ScoreboardColorsBlockBg.w += BlockPadding;
  ScoreboardColorsBlockBg.h += BlockPadding;
  ScoreboardColorsBlockBg.x -= BlockPadding * 0.5f;
  ScoreboardColorsBlockBg.y -= BlockPadding * 0.5f;
  ScoreboardColorsBlockBg.Draw(BlockColor, IGraphics::CORNER_ALL, 10.0f);

  ScoreboardColorsBlock.HSplitTop(LineSize, &Label, &ScoreboardColorsBlock);
  Ui()->DoLabel(&Label, Localize("Tab colors"), HeadlineFontSize, TEXTALIGN_ML);
  ScoreboardColorsBlock.HSplitTop(MarginSmall, nullptr, &ScoreboardColorsBlock);
  ScoreboardColorsBlock.HSplitTop(LineSize, &Button, &ScoreboardColorsBlock);
  Ui()->DoScrollbarOption(&g_Config.m_BcScoreboardTransparency, &g_Config.m_BcScoreboardTransparency, &Button, Localize("Tab transparency"), 0, 100, &CUi::ms_LinearScrollbarScale, CUi::SCROLLBAR_OPTION_DELAYUPDATE, "%");
  ScoreboardColorsBlock.HSplitTop(MarginSmall, nullptr, &ScoreboardColorsBlock);

  ScoreboardColorsBlock.HSplitTop(ScoreboardColorPickerSpacing, nullptr, &ScoreboardColorsBlock);
  static CButtonContainer s_ScoreboardBackgroundColorButton;
  DoLine_ColorPicker(&s_ScoreboardBackgroundColorButton, ScoreboardColorPickerLineSize, 13.0f, ScoreboardColorPickerSpacing, &ScoreboardColorsBlock, Localize("Tab background color"), &g_Config.m_BcScoreboardBackgroundColor, color_cast<ColorRGBA>(ColorHSLA(DefaultConfig::BcScoreboardBackgroundColor, true)), false);

  ScoreboardColorsBlock.HSplitTop(ScoreboardColorPickerSpacing, nullptr, &ScoreboardColorsBlock);
  static CButtonContainer s_ScoreboardPingBarColorButton;
  DoLine_ColorPicker(&s_ScoreboardPingBarColorButton, ScoreboardColorPickerLineSize, 13.0f, ScoreboardColorPickerSpacing, &ScoreboardColorsBlock, Localize("Tab ping bar color"), &g_Config.m_BcScoreboardPingBarColor, color_cast<ColorRGBA>(ColorHSLA(DefaultConfig::BcScoreboardPingBarColor, true)), false);

  ScoreboardColorsBlock.HSplitTop(ScoreboardColorPickerSpacing, nullptr, &ScoreboardColorsBlock);
  static CButtonContainer s_ScoreboardPingTextColorButton;
  DoLine_ColorPicker(&s_ScoreboardPingTextColorButton, ScoreboardColorPickerLineSize, 13.0f, ScoreboardColorPickerSpacing, &ScoreboardColorsBlock, Localize("Tab ping text color"), &g_Config.m_BcScoreboardPingTextColor, color_cast<ColorRGBA>(ColorHSLA(DefaultConfig::BcScoreboardPingTextColor, true)), false);
...
void CMenus::RenderSettingsBestClientGameplay(CUIRect MainView)
{
	...
	// Freeze Tee Hook Laser
Column.HSplitTop(MarginBetweenViews, nullptr, &Column);

const float FreezeLaserBlockHeight = 285.0f;
CUIRect FreezeLaserBlock;
Column.HSplitTop(FreezeLaserBlockHeight, &FreezeLaserBlock, &Column);

CUIRect FreezeLaserBlockBg = FreezeLaserBlock;
FreezeLaserBlockBg.w += BlockPadding;
FreezeLaserBlockBg.h += BlockPadding;
FreezeLaserBlockBg.x -= BlockPadding * 0.5f;
FreezeLaserBlockBg.y -= BlockPadding * 0.5f;
FreezeLaserBlockBg.Draw(BlockColor, IGraphics::CORNER_ALL, 10.0f);

CUIRect FreezeLaserView = FreezeLaserBlock;
CUIRect FreezeLaserLabel, FreezeLaserButton, FreezeLaserContent;

FreezeLaserView.HSplitTop(LineSize, &FreezeLaserLabel, &FreezeLaserView);
Ui()->DoLabel(&FreezeLaserLabel, Localize("Freeze Tee Hook Laser"), HeadlineFontSize, TEXTALIGN_ML);
FreezeLaserView.HSplitTop(MarginSmall, nullptr, &FreezeLaserView);

FreezeLaserView.HSplitTop(LineSize, &FreezeLaserContent, &FreezeLaserView);
DoButton_CheckBoxAutoVMarginAndSet(&g_Config.m_BcFreezeLaser, Localize("Enable freeze tee hook laser"), &g_Config.m_BcFreezeLaser, &FreezeLaserContent, LineSize);

FreezeLaserView.HSplitTop(MarginSmall, nullptr, &FreezeLaserView);
FreezeLaserView.HSplitTop(LineSize, &FreezeLaserButton, &FreezeLaserView);
Ui()->DoScrollbarOption(&g_Config.m_BcFreezeLaserMaxDistance, &g_Config.m_BcFreezeLaserMaxDistance, &FreezeLaserButton, Localize("Maximum distance"), 100, 5000);

FreezeLaserView.HSplitTop(MarginSmall, nullptr, &FreezeLaserView);
FreezeLaserView.HSplitTop(LineSize, &FreezeLaserButton, &FreezeLaserView);
Ui()->DoScrollbarOption(&g_Config.m_BcFreezeLaserWidth, &g_Config.m_BcFreezeLaserWidth, &FreezeLaserButton, Localize("Line width"), 1, 20);

FreezeLaserView.HSplitTop(MarginSmall, nullptr, &FreezeLaserView);
FreezeLaserView.HSplitTop(LineSize, &FreezeLaserButton, &FreezeLaserView);
Ui()->DoScrollbarOption(&g_Config.m_BcFreezeLaserAlpha, &g_Config.m_BcFreezeLaserAlpha, &FreezeLaserButton, Localize("Opacity"), 0, 100);

FreezeLaserView.HSplitTop(MarginSmall, nullptr, &FreezeLaserView);
FreezeLaserView.HSplitTop(LineSize, &FreezeLaserButton, &FreezeLaserView);
CUIRect FreezeLaserStyleSolid, FreezeLaserStyleDashed;
FreezeLaserButton.VSplitMid(&FreezeLaserStyleSolid, &FreezeLaserStyleDashed, 2.0f);
FreezeLaserStyleSolid.HMargin(2.0f, &FreezeLaserStyleSolid);
FreezeLaserStyleDashed.HMargin(2.0f, &FreezeLaserStyleDashed);
static CButtonContainer s_FreezeLaserStyleSolidButton;
static CButtonContainer s_FreezeLaserStyleDashedButton;
if(DoButton_Menu(&s_FreezeLaserStyleSolidButton, Localize("Solid"), g_Config.m_BcFreezeLaserStyle == 0, &FreezeLaserStyleSolid, BUTTONFLAG_LEFT, nullptr, IGraphics::CORNER_L))
        g_Config.m_BcFreezeLaserStyle = 0;
if(DoButton_Menu(&s_FreezeLaserStyleDashedButton, Localize("Dashed"), g_Config.m_BcFreezeLaserStyle == 1, &FreezeLaserStyleDashed, BUTTONFLAG_LEFT, nullptr, IGraphics::CORNER_R))
        g_Config.m_BcFreezeLaserStyle = 1;

FreezeLaserView.HSplitTop(MarginSmall, nullptr, &FreezeLaserView);
static CButtonContainer s_FreezeLaserColorButton;
DoLine_ColorPicker(&s_FreezeLaserColorButton, LineSize, 13.0f, MarginSmall, &FreezeLaserView, Localize("Main color"), &g_Config.m_BcFreezeLaserColor, ColorRGBA(0.2f, 0.6f, 1.0f, 1.0f), false);

FreezeLaserView.HSplitTop(MarginSmall, nullptr, &FreezeLaserView);
static CButtonContainer s_FreezeLaserHookableColorButton;
DoLine_ColorPicker(&s_FreezeLaserHookableColorButton, LineSize, 13.0f, MarginSmall, &FreezeLaserView, Localize("Hookable color"), &g_Config.m_BcFreezeLaserHookableColor, ColorRGBA(0.1f, 1.0f, 0.2f, 1.0f), false);

FreezeLaserView.HSplitTop(MarginSmall, nullptr, &FreezeLaserView);
static CButtonContainer s_FreezeLaserUnhookableColorButton;
DoLine_ColorPicker(&s_FreezeLaserUnhookableColorButton, LineSize, 13.0f, MarginSmall, &FreezeLaserView, Localize("Unhookable color"), &g_Config.m_BcFreezeLaserUnhookableColor, ColorRGBA(1.0f, 0.2f, 0.2f, 1.0f), false);
...
void CMenus::RenderSettingsBestClientInfo(CUIRect MainView)
{
	...
	// РІвЂќР‚РІвЂќР‚ BestClient Links РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
	...
	// РІвЂќР‚РІвЂќР‚ Config Files (anchored to the bottom of the left column) РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
	...
	// РІвЂќР‚РІвЂќР‚ BestClient Developers РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
	...
	// РІвЂќР‚РІвЂќР‚ Hide Settings Tabs РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
	RightView.HSplitTop(MarginSmall, nullptr, &RightView);
	RightView.HSplitTop(HeadlineHeight, &Label, &RightView);
