...
class CPlayers : public CComponent
{
    ...
    void RenderHookCollLine(
        ...
        const CNetObj_Character *pPlayerChar,
        int ClientId,
        const vec2 *pOverridePosition = nullptr,
        const vec2 *pOverrideDirection = nullptr,
        const float *pOverrideLength = nullptr);
    ...
    vec2 m_aLastTeePos[MAX_CLIENTS] = {};
    bool m_aLastTeePosValid[MAX_CLIENTS] = {};
    bool m_aDeadTee[MAX_CLIENTS] = {};
    bool m_aTeeWasInactive[MAX_CLIENTS] = {};

public:
    void MarkTeeDead(int ClientId);
